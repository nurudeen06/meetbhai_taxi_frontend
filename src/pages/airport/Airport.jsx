...
export default function Airport() {
    ...
    const fetchAirports = async () => {
        try {
            const response = await fetch('https://sore-tan-rabbit-hem.cyclic.app/api/v1/airports');
    ...
    const handleAddAirport = async () => {
        try {
            const response = await fetch('https://sore-tan-rabbit-hem.cyclic.app/api/v1/airport', {
                method: 'POST',
                headers: {
