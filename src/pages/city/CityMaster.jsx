            ...
            <div className="w-100 flex h-[calc(100vh-60px)]">
                ...
                <div className="w-fit min-w-[300px] max-w-[350px] p-3 flex flex-col gap-4 items- justify- bs-yellow relative">
                    ...
                    <div className="w-fit mx-auto">
                        <p className='text-[25px] tx-white font-bold font-Outfit'>Add Airport</p>
                    </div>
                    <div className="w-100 mx-auto flex flex-col gap-3 items-">
                        <div className="w-100">
                            <Select
                                ...
                                className="max-w-xs"
                            >
                                {animals.map((animal) => (<SelectItem key={animal.value}>{animal.label}</SelectItem>))}
                            </Select>
                        </div>
                        <div className="w-100">
                            <Input className='rounded-xl overflow-hidden bs-white' size="sm" type="text" placeholder=" Airport Name" />
                        </div>
